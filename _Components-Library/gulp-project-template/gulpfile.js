...
const outToTtf = () => {
    ...
    return src(`dev/fonts/*.{eot,otf,ttf}`, {})
        // Конвертируем в .ttf
        .pipe(fonter({
            formats: ['ttf']
        }))
...
exports.default = parallel(series(cleanRelease, building, imageCopy, outToTtf, fontsStyle, styleConcat, scss2cssMain, scss2cssComponent, cssCopy, scriptsConcat, scriptsCopy, fileincluding), browserSyncFunction, watching);